...
# Configura il tuo client MongoDB
client = MongoClient('mongodb://localhost:27017/')
db = client['BEvent']

class Servizio:
    def __init__(self, _id, descrizione, tipo, prezzo, disponibilita_data_inizio, disponibilita_data_fine, quantita, foto_servizio, fornitore_associato):
        self._id = _id
