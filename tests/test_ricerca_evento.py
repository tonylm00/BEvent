...
from BEvent_app.RicercaEvento.RicercaEventoService import ricerca_eventi_per_parola, ricerca_eventi_per_categoria, \
    ricerca_eventi_per_regione, ricerca_eventi_per_prezzo
