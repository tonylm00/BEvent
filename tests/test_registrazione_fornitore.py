...
def test_registra_forn_1_1_1(mock_app):
    with mock_app.test_request_context():
        with mock_app.app_context():
            result = registra_forn("Teresa", "Rossi", "TRATTORIADATERESADICASERTAINVIABRIGIDA", "rossit@gmail.com",
                                   "Ciao.123",
                                   "Ciao.123", "0123456789",
                                   "12-12-1984", "Caserta", "3", "Trattoria elegante con spazio all'aperto e piscina",
                                   True, "2",
    ...
    with mock_app.test_request_context():
        with mock_app.app_context():
            result = registra_forn("Teresa", "Rossi", "Trattoria da Terry", "rossit@gmail.com", "Ciao.3",
                                   "Ciao.3", "0123456789",
                                   "1984-12-12", "Caserta", "3", "Trattoria elegante con spazio all'aperto e piscina",
                                   True, "2",
                                   "Via Vigna Brigida 20", "01234567890", "Campania")
            message = get_flashed_messages(category_filter="error")
...
def test_registra_forn_1_1_10(mock_app):
    with mock_app.test_request_context():
        with mock_app.app_context():
            result = registra_forn("Teresa", "Rossi", "Trattoria da Terry", "rossit@gmail.com", "Ciao.123",
                                   "Ciao.123", "0123456789",
                                   "12-12-2024", "Caserta", "3", "Trattoria elegante con spazio all'aperto e piscina",
                                   True, "2",
                                   "Via Vigna Brigida 20", "01234567890", "Campania")
            message = get_flashed_messages(category_filter="error")
